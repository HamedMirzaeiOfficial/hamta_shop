...
class ProductComment(SingleObjectMixin, FormView):
    ...
    def get_success_url(self):
        messages.success(self.request, 'نظر شما ثبت شد. پس از تایید ادمین در سایت قرار میگیرد.')
...
class ContactView(CreateView):
    ...
    def get_success_url(self):
        messages.success(self.request, 'نظر شما ثبت گردید. در اسرع وقت توسط ادمین بررسی میشود. ممنون از شما.')
